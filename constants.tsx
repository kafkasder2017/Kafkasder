...
import { NavItem, KullaniciRol } from './types';
...
export const ICONS = {
    ...
    PEOPLE: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-2.308l.143-.143-1.05-1.05a2.25 2.25 0 0 1-1.586-.858c-.035-.052-.072-.105-.108-.158l-1.3-1.3a2.25 2.25 0 0 0-3.182 0l-1.3 1.3a2.25 2.25 0 0 1-1.585.858l-1.05 1.05a9.337 9.337 0 0 0 4.121 2.308M15 19.128v-2.828l-1.3-1.3a2.25 2.25 0 0 0-3.182 0l-1.3 1.3a2.25 2.25 0 0 1-1.585.858l-1.05 1.05a9.337 9.337 0 0 0 4.121 2.308M12 6.75a2.25 2.25 0 1 1 0 4.5 2.25 2.25 0 0 1 0-4.5Zm0 0a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Zm-4.5 0a2.25 2.25 0 1 1 0 4.5 2.25 2.25 0 0 1 0-4.5Zm0 0a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Zm9 0a2.25 2.25 0 1 1 0 4.5 2.25 2.25 0 0 1 0-4.5Zm0 0a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z" /></svg>,
    AID_RECIPIENT: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c.966 0 1.891-.418 2.57-1.126a9.75 9.75 0 0 1 4.293-3.692c.308-.146.634-.26.974-.359a1.125 1.125 0 0 1 .868 1.125v.75a1.125 1.125 0 0 1-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125v-.75a1.125 1.125 0 0 1 .868-1.125c.34-.1.666-.213.974-.359a9.75 9.75 0 0 1 4.293-3.692c.679-.708 1.604-1.126 2.57-1.126m-15.75 0c.966 0 1.891-.418 2.57-1.126a9.75 9.75 0 0 1 4.293-3.692c.308-.146.634-.26.974-.359a1.125 1.125 0 0 1 .868 1.125v.75a1.125 1.125 0 0 1-1.125 1.125h-9.75A1.125 1.125 0 0 1 3 16.5v-.75a1.125 1.125 0 0 1 .868-1.125c.34-.1.666-.213.974-.359a9.75 9.75 0 0 1 4.293-3.692c.679-.708 1.604-1.126 2.57-1.126m4.5 0c.966 0 1.891-.418 2.57-1.126a9.75 9.75 0 0 1 4.293-3.692c.308-.146.634-.26.974-.359a1.125 1.125 0 0 1 .868 1.125v.75a1.125 1.125 0 0 1-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125v-.75a1.125 1.125 0 0 1 .868-1.125c.34-.1.666-.213.974-.359a9.75 9.75 0 0 1 4.293-3.692c.679-.708 1.604-1.126 2.57-1.126M4.5 9.75a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm15 0a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-7.5 0a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" /></svg>,
    SCHOLARSHIP: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.57 50.57 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" /></svg>,
    KUMBARA: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6V5.25m0 0a3 3 0 0 1 3-3h1.5a3 3 0 0 1 3 3V5.25m0 0v.75a.75.75 0 0 1-.75-.75V5.25m6-1.5V5.25a.75.75 0 0 0-.75-.75h-1.5a3 3 0 0 0-3 3V5.25m0 0v.75a.75.75 0 0 0 .75-.75V5.25m6 3.75a.75.75 0 0 1-.75-.75V5.25m0 0a3 3 0 0 1 3-3h1.5a3 3 0 0 1 3 3V5.25m0 0v.75a.75.75 0 0 1-.75-.75V5.25M9 9.75a3 3 0 0 1-3 3H3.75a3 3 0 0 1-3-3v-1.5a3 3 0 0 1 3-3H6a3 3 0 0 1 3 3v1.5Zm12 0a3 3 0 0 1-3 3h-1.5a3 3 0 0 1-3-3v-1.5a3 3 0 0 1 3-3H18a3 3 0 0 1 3 3v1.5Z" /></svg>,
    LEGAL: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52v1.666c0 .414-.162.798-.448 1.084a8.97 8.97 0 0 1-11.104 0c-.286-.286-.448-.67-.448-1.084V5.49a48.507 48.507 0 0 1 3-.52M3.75 5.49v1.666c0 .414.162.798.448 1.084 1.186 1.186 3.041 1.886 4.802 1.886s3.616-.7 4.802-1.886c.286-.286-.448-.67-.448-1.084V5.49M9 9.75h6m-6 3.75h6m-6 3.75h6" /></svg>,
    CALENDAR: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M12 11.25h.008v.008H12v-.008Zm0 3.75h.008v.008H12v-.008Zm3.75-3.75h.008v.008h-.008v-.008Zm0 3.75h.008v.008h-.008v-.008Zm-7.5 0h.008v.008H8.25v-.008Zm3.75 0h.008v.008H12v-.008ZM8.25-3.75h.008v.008H8.25v-.008ZM15.75 7.5h.008v.008h-.008V7.5Z" /></svg>,
    CLIPBOARD_DOCUMENT_LIST: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 5.25 6h.008a2.25 2.25 0 0 1 2.242 2.15 48.062 48.062 0 0 1-.61 4.135A2.25 2.25 0 0 1 5.25 15h-.008a2.25 2.25 0 0 1-2.242-2.15A48.06 48.06 0 0 1 3 8.847V6.108c0-1.135.845-2.098 1.976-2.192a48.424 48.424 0 0 1 1.123-.08" /></svg>,
    FINANCE: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" /></svg>,
    ...
    LIGHTBULB: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c-1.42 0-2.798-.31-4.007-1.026A3 3 0 0 1 3 13.5v-1.125c0-1.68.768-3.18 1.95-4.195C6.42 6.648 8.108 6 10.5 6h3c2.392 0 4.08.648 5.55 2.18C20.232 9.18 21 10.68 21 12.375v1.125a3 3 0 0 1-1.993 2.849 11.957 11.957 0 0 1-4.007 1.026Z" /></svg>,
    ...
    CHEVRON_DOWN: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" /></svg>,
    SUN: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" /></svg>,
    MOON: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" /></svg>,
    BELL: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" /></svg>,
    ...
    X_MARK: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" /></svg>,
    HAMBURGER: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></svg>,
};
...
export const NAVIGATION_ITEMS: NavItem[] = [
    ...
    {
        path: '/ayarlar', name: 'Parametreler & Tanımlar', icon: ICONS.SETTINGS, roles: [YONETICI],
        subItems: [
            ...
            { path: '/ayarlar/google-cloud', name: 'Google Cloud Entegrasyonu' },
