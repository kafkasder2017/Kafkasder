...
import { generateAnalyticsSummary } from '../services/huggingfaceService';
import type {
  Person,
  YardimBasvurusu,
  FinansalKayit,
  ...
  <div className='bg-white dark:bg-zinc-800 p-6 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 lg:col-span-2'>
    <div className='flex justify-between items-center mb-4'>
      ...
      <button
        onClick={onGenerate}
        disabled={isLoading}
        className='bg-purple-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-purple-700 transition-colors flex items-center space-x-2 text-sm disabled:bg-purple-300'
      >
        {isLoading ? (
