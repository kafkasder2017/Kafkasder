...
export enum DavaStatus {
  _DEVAM_EDEN = 'Devam Ediyor',
  _SONUCLANAN = 'Sonuçlandı',
  _TEMYIZDE = 'Temyizde'
}
...
export enum ProjeStatus {
  _PLANLAMA = 'Planlama',
  _DEVAM_EDIYOR = 'Devam Ediyor',
  _TAMAMLANDI = 'Tamamlandı',
  _IPTAL_EDILDI = 'İptal Edildi'
}
